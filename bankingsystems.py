...
customerNames = ['Chandra Kanth', 'Bharath Kumar', 'Pavan Kumar', 'Bhumi Chandra', 'Vijay Kumar']
...
while True:
    ...
    choiceNumber = input("Select your choice number from the above menu to process your request : ")
    if choiceNumber == "1":
